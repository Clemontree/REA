...
[Firesting.TestDataset]=uploading_firesting_2020(mydirectory+"20201015-planaqua.txt"); %uploading file created by oxymeter for the segment
...
% OxDW = oxygen8HzDw(OxiStart:OxiEnd);
    ...
    Automate.velocityZ = Automate.velocityFileSegt(:,9)/1000;
    Automate.velocityY = Automate.velocityFileSegt(:,8)/1000; 
    Automate.velocityX = Automate.velocityFileSegt(:,7)/1000;
...
REA.OxyFlux(iDeployment) = (REA.bCoefFit(iDeployment)*REA.stdVelocityZ(iDeployment)*REA.oxyDifConcCompensated(iDeployment))*24*3600/1000; %mmol/m2/day
