...
set(0, 'defaultFigureUnits', 'centimeters', 'defaultFigurePosition', [0 0 1 1]);
...
CorrelationFig1 = figure('Name','time shifts and p-value for min-max correlation with velocity 1','NumberTitle','off');
CorrelationFig2 = figure('Name','time shifts and p-value for min-max correlation with velocity 2','NumberTitle','off');
OgiveFig1 = figure('Name','ogives: REA (..) and EC(-) O2 1','NumberTitle','off');
OgiveFig2 = figure('Name','ogives: REA (..) and EC(-) O2 2','NumberTitle','off');
...
VelFig1 = figure('Name','ADV Vertical Velocities PF 800 points 1','NumberTitle','off');
VelFig2 = figure('Name','ADV Vertical Velocities PF 800 points 2','NumberTitle','off');
VelFluFig1 = figure('Name','ADV Vertical Velocities fluctuation 60s running average 1','NumberTitle','off');
VelFluFig2 = figure('Name','ADV Vertical Velocities fluctuation 60s running average 2','NumberTitle','off');
...
[~, velocityZPrime_TimeShift, oxygenPrime_TimeShift, FluxesShifted(iSegment,2), FluxesNoShifted(1,iSegment), ~, ~, ~, bestPValue(iSegment), pValues{1, iSegment}, timeShift{1, iSegment}, iShiftOxygen(iSegment)] ...
     = segment_time_shift_EC_imposed( Param,Time, u5(1+iSegmentDuration*(iSegment-1):iSegmentDuration*iSegment,3), Oxygen4EC(:,iSegment), 1);% PFsynchronization of oxygen over velocity for EC flux calculation
...
Para = {'Segment 1';'Segment 2';'Segment 3';'Segment 4';'Segment 5';'Segment 6';'Segment 7';'Segment 8';'Segment 9';'Segment 10';'Segment 11';'Segment 12';'Segment 13'}
TEC = table(meanW', stdW',meanWFluctuation', stdWFluctuation', FluxesShifted(:,2),'RowNames',Para);
TEC.Properties.VariableNames = {'Mean W' 'W fluctuation' 'Mean W''' 'W'' Fluctuation' 'Flux'}
